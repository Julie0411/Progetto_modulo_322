...
export default class RecyclerListView extends ComponentCompat {
  static defaultProps = {
    initialOffset: 0,
  ...
  renderCompat() {
    return /*#__PURE__*/React.createElement(ScrollComponent, _extends({
  ...
  _renderRowUsingMeta(itemMeta) {
    ...
    if (!isNullOrUndefined(dataIndex) && dataIndex < dataSize) {
      ...
      return /*#__PURE__*/React.createElement(ViewRenderer, {
        key: key,
        x: itemRect.x,
        y: itemRect.y,
        index: dataIndex,
