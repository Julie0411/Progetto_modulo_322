...
const usePinchToZoom = () => {
  ...
  const pinchGesture = Gesture.Pinch().onBegin(() => {
    ...
    const clampedHeight = clampValues(newHeight, minTimeIntervalHeight - 8, maxTimeIntervalHeight + 8);
    ...
    const finalHeight = clampValues(timeIntervalHeight.value, minTimeIntervalHeight, maxTimeIntervalHeight);
