...
const SingleDayBarItem = ({
  ...
  const {
    data: events,
    eventCounts
  } = useAllDayEventsByDay(startUnix);
  const {
    onPressEvent,
    onPressBackground,
  ...
  const _renderSingleDay = () => {
    if (useAllDayEvent) {
      ...
      }, events.map(_renderEvent)), eventCounts > COLLAPSED_ITEMS && /*#__PURE__*/React.createElement(EventCounts, {
  ...
  }, _renderSingleDay(), /*#__PURE__*/React.createElement(LoadingOverlay, null), /*#__PURE__*/React.createElement(ProgressBar, null));
};
...
const EventCounts = ({
  ...
  }, locale.more.replace('{count}', `${eventCounts - COLLAPSED_ITEMS}`)), /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: StyleSheet.absoluteFill,
    onPress: () => {
