...
import { LayoutProvider, RecyclerListView } from '../../service/recyclerlistview';
const MAX_OFFSETS = 180537;
const CalendarListView = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    count,
    width,
    height,
  ...
  const _renderItemContainer = (containerProps, _parentProps, children) => {
    const style = StyleSheet.flatten([containerProps.style, inverted ? styles.invertedTransform : {}]);
  ...
  return /*#__PURE__*/React.createElement(RecyclerListView, {
    ref: ref,
...
export default /*#__PURE__*/React.memo(CalendarListView);
