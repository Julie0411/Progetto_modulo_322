...
const MultiDayBarItem = ({
  ...
  const dayBarStyles = useTheme(useCallback(state => ({
  ...
  const {
    data: events,
    eventCounts
  } = useAllDayEvents(startUnix, numberOfDays, visibleDates);
  ...
  const _renderDayItem = date => {
    ...
    }) : /*#__PURE__*/React.createElement(DayItem, {
      dateUnix: visibleDates[date].unix
    }));
  };
  ...
  const _renderBottomColumn = date => {
    ...
    return /*#__PURE__*/React.createElement(BottomColumn, {
      key: `bottom_${date}`,
      count: count,
  ...
  }, Object.keys(visibleDates).map(_renderDayItem)), /*#__PURE__*/React.createElement(Animated.View, {
  ...
  }), events.map(_renderEvent)), /*#__PURE__*/React.createElement(View, {
    style: [styles.bottomContainer, dayBarStyles.headerBottomContainer]
  }, Object.keys(visibleDates).map(_renderBottomColumn)), /*#__PURE__*/React.createElement(LoadingOverlay, null), /*#__PURE__*/React.createElement(ProgressBar, null));
};
...
const BottomColumn = ({
  ...
  }), isShowCount && /*#__PURE__*/React.createElement(Animated.View, {
    style: [styles.countContainer, countContainerStyle, {
      height: headerBottomHeight
    }, countStyle]
  }, /*#__PURE__*/React.createElement(Text, {
    style: [styles.countText, countTextStyle]
  }, "+", count - collapsedItems), /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: StyleSheet.absoluteFill,
    onPress: () => {
...
const EventItem = ({
  ...
  const eventWidth = useDerivedValue(() => _internal.columnSpan * columnWidthAnim.value - rightEdgeSpacing, [_internal.columnSpan, rightEdgeSpacing]);
