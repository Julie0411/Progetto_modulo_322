...
export declare const CalendarContext: React.Context<CalendarContextProps | undefined>;
declare const CalendarProvider: FC<PropsWithChildren<{
    value: CalendarContextProps;
}>>;
