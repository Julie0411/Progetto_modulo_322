...
import type { OutOfRangeProps, PackedEvent, RenderHourProps, SizeAnimation, UnavailableHourProps } from '../types';
...
export interface BodyContextProps {
    ...
    renderCustomUnavailableHour?: (props: UnavailableHourProps & {
...
export declare const BodyContext: React.Context<BodyContextProps | undefined>;
export declare const useBody: () => BodyContextProps;
//# sourceMappingURL=BodyContext.d.ts.map