...
exports.toHourStr = exports.startOfWeek = exports.parseDateTime = exports.parseDate = exports.getWeekNumberOfYear = exports.forceUpdateZone = exports.endOfWeek = exports.diffDays = exports.dateToDtStart = exports.dateTimeToISOString = void 0;
var _luxon = require("luxon");
const parseDateTime = (date, opts) => {
  if (date instanceof _luxon.DateTime) {
    return opts ? _luxon.DateTime.fromObject(date.toObject(), opts) : date;
  }
  if (date instanceof Date) {
    return _luxon.DateTime.fromJSDate(date, opts);
  }
  if (typeof date === 'string') {
    return _luxon.DateTime.fromISO(date, opts);
  }
  if (typeof date === 'number') {
    return _luxon.DateTime.fromMillis(date, opts);
  }
  return _luxon.DateTime.local(opts);
};
exports.parseDateTime = parseDateTime;
const parseDate = (date, forceNewDate = true) => {
...
const endOfWeek = (date, weekStartsOn) => {
...
const dateTimeToISOString = date => date.toUTC().toISO();
exports.dateTimeToISOString = dateTimeToISOString;
const dateToDtStart = date => {
...
exports.dateToDtStart = dateToDtStart;
const toHourStr = (originalMinutes, hourFormat, meridiem) => {
...
exports.toHourStr = toHourStr;
const getWeekNumberOfYear = (date, timeZone) => {
  'worklet';

  return parseDateTime(date).setZone(timeZone).weekNumber;
};
exports.getWeekNumberOfYear = getWeekNumberOfYear;
const forceUpdateZone = (date, zone = 'local') => {
  return parseDateTime(date).setZone(zone, {
    keepLocalTime: true
  });
};
exports.forceUpdateZone = forceUpdateZone;
