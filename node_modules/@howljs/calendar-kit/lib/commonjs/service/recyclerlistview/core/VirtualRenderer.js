...
var _RecycleItemPool = _interopRequireDefault(require("../utils/RecycleItemPool"));
var _utils = require("../utils/utils");
var _ViewabilityTracker = _interopRequireDefault(require("./ViewabilityTracker"));
...
class VirtualRenderer {
  ...
  getInitialOffset() {
    ...
    if (this._params) {
      offset.x = (0, _utils.valueWithDefault)(this._params.initialOffset, 0);
      offset.y = 0;
    }
    return offset;
  }
  init() {
    ...
    this._recyclePool = new _RecycleItemPool.default();
    if (this._params) {
      this._viewabilityTracker = new _ViewabilityTracker.default((0, _utils.valueWithDefault)(this._params.renderAheadOffset, 0), (0, _utils.valueWithDefault)(this._params.initialOffset, 0), this._params.columnsPerPage, this._params.extraScrollData);
    } else {
      this._viewabilityTracker = new _ViewabilityTracker.default(0, 0);
    }
    this._prepareViewabilityTracker();
  }
  ...
  syncAndGetKey(index) {
    ...
    if ((0, _utils.isNullOrUndefined)(key)) {
      ...
      if (!(0, _utils.isNullOrUndefined)(key)) {
        ...
        if (itemMeta) {
          ...
          if (!(0, _utils.isNullOrUndefined)(oldIndex) && oldIndex !== index) {
    ...
    if (!(0, _utils.isNullOrUndefined)(this._engagedIndexes[index])) {
  ...
  _onEngagedItemsChanged = (_all, now, notNow) => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      if (this._params && disengagedIndex < this._params.itemCount) {
        ...
        if (!(0, _utils.isNullOrUndefined)(resolvedKey)) {
